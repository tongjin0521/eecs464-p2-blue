...
if not mswindows and not apple:
  # Scan libpcan.h
...
if mswindows:
    ...
    print "" #no driver exists for Mac OS. Must use our Xbee serial interface
else:
    print "\ntry:"
    print "\n  lib = cdll.LoadLibrary('libpcan.so')"
    print "\nexcept OSError:"
    print "\n  print '''"
    print "\n  libpcan is not installed. Please install the API/driver for the PCAN"
    print "\n  devices: "
...
sys.stderr.write("WARNING: on Darwin (MAC) only zigbee and direct serial interfaces are supported\n")
"""
